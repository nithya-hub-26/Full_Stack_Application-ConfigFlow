...
def get_resources():
    logging.info("Starting the get_resources process.")
    # Forming the request
    url_path = get_url() + "/resources"
    headers = {"accept": "application/json", "CustomToken": get_token()}
    params = {"type": "DCM", "includeStateInfo": "false", "includeUsage": "false"}
...
logging.info("Finished the get_resources process.")
