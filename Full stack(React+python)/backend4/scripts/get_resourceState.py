...
def get_resourceState(url):
    logging.info("Starting the get_resourceState process.")
    # Forming the request
    url_path = f"https://{url}:8443/State"
...
logging.info("Finished the get_resourceState process.")
